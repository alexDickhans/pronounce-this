...
namespace Pronounce {
	...
	CatapultHold catapultHold("CatapultHold", catapultMotors, 1.27 * 20.0/15.0);
	...
	void initCatapult() {
		...
		catapultMotors.at(0).set_zero_position(1.25 * 20.0/15.0);
		catapultMotors.at(1).set_zero_position(1.25 * 20.0/15.0);
	}
}