...
/*
		...
		rightNeutralToFarPlatformIndex = purePursuit->addPath(rightNeutralToFarPlatform.getPath(0.05));
...
*/
		...
		rightNeutralToRightAllianceGoal.addPoint(SplinePoint(Point(125, 37), Vector(15, -M_PI_4)));
